-- Fix create_captain_connection to bypass RLS by using SECURITY DEFINER
...
BEGIN
  ...
  -- p_captain_player_id is draft_room_players.id
  ...
  -- Check if connection already exists for this captain_player_id
  IF EXISTS (
...
-- Also fix update_captain_heartbeat to use SECURITY DEFINER
